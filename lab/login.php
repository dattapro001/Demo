...
<body> 
            ...
            <h3 data-text="Welcome to our website please login or sign up for  se our features what may">Welcome to our website please login or sign up for  se our feature what may</h3>
            ...
            <div class="btn-container">
                <a href="home.html" class="btn1">VISIT WEBSITE</a>
            ...
            <div class="wrapper" id="wrapper">
                ...
                <div class="login-box">
                    ...
                    <form action="loginAction.php" method="post">
                        ...
                        <input <a href="" type="submit" value="Login" class="stop" id="submit"></a>
                        <div class="login-register">
                            <p>Sign up for an account</p>
                        </div>
                    </form>
                    <div class="login-as">
                            <a href="#wrapper" class="register-link">Admin</a>
                            <a href="Client-Login.html" class="register-link">Staff</a>
                            <a href="#wrapper" class="register-link">Client</a>
                        </div>
                </div>
